...
class ChartHelper
{
    public:
        ...
        static constexpr Fl_Color colors[] = {FL_RED, FL_GREEN, FL_BLUE,
            FL_MAGENTA, FL_BLACK, FL_DARK_RED, FL_DARK_GREEN, 176, FL_DARK_CYAN,
            FL_DARK_MAGENTA, FL_DARK_YELLOW, 181, 91, 243, 235, 162, 115, 200,
            212, 83, FL_CYAN, FL_YELLOW};
